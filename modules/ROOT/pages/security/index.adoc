...
Authentication and authorization are enabled by default in Neo4j (refer to link:/docs/operations-manual/{neo4j-version}/authentication-authorization#auth[Operations Manual -> Authentication and authorization]).
