...
Authentication and authorization are enabled by default in Neo4j (refer to xref:4.0@operations-manual:ROOT:authentication-authorization/index.adoc#auth[Operations Manual -> Authentication and authorization]).
