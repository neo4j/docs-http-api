...
See link:{neo4j-docs-base-uri}/query-api/current/query-counters/[Query API -> Retrieve query counters] for details on how to retrieve query counters with the Query API.
====
