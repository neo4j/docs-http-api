...
[WARNING]
====
The transactional HTTP API is deprecated and replaced by the Query API.
See the link:{neo4j-docs-base-uri}/query-api/current/[Neo4j Query API] documentation for more information.
====
