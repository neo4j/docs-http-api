...
See link:{neo4j-docs-base-uri}/query-api/current/routing/[Query API -> Route queries to read cluster members] for details on how to route queries to read cluster members with the Query API.
====
