...
The Cypher Transactional API provides a limited level of support for query routing. The level of support depends on whether xref:4.4-preview@operations-manual:ROOT:clustering/internals.adoc#causal-clustering-routing[Server-side Routing]  has been enabled.
