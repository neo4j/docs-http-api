...
See link:{neo4j-docs-base-uri}/query-api/current/bookmarks/[Query API -> Coordinate transactions and enforce causal consistency] for details on how to use bookmarks with the Query API.
====
